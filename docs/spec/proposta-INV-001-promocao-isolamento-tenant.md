...
2. **Latentes não expostos.** Cart id-methods e history-import (serviço desligado) foram endereçados/documentados, mas o commerce e o cart CRUD seguem como código sem rota. A regra derivada ("escopar antes de expor") os cobre por convenção, não por barreira automática.
