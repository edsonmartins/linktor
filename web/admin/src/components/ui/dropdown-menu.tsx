...
/**
 * Dropdown Menu - Compound Component Pattern (Plugin Design)
 * Wraps Radix primitives with terminal-themed styling
 * Each sub-component is a "plugin" that can be composed
 */
